    ...
    <footer className="bg-primary-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 text-accent-500">Business approval-e2e-1768122441</h3>
            <p className="text-gray-300">
              Professional business-approval-e2e-1768122441 services you can trust.
            </p>
          </div>
        ...
        <div className="border-t border-primary-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Business approval-e2e-1768122441. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
